...
- E2E tests for registration, login, RBAC, course creation, instructor assignment, checkout, duplicate webhooks, wallet ledger, withdrawals, financial exports, learning access, and enrollment access.
