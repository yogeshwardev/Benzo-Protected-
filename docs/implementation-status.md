...
- E2E tests for registration, login, RBAC, course creation, instructor assignment, checkout, duplicate webhooks, wallet ledger, and enrollment access.
- Real admin forms wired to authenticated API clients.
- Financial exports, refunds, withdrawal processing, and invoice PDF generation.
