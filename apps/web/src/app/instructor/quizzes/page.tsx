    ...
    <main className="mx-auto min-h-screen max-w-7xl px-5 py-8 md:px-8">
      ...
      <section className="mt-8 grid gap-4 md:grid-cols-2">
        <article className="rounded-lg border border-[var(--line)] bg-white p-5">
          ...
          <h2 className="font-semibold">MCQ setup</h2>
          <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
            Questions store options, correct option index, points, and explanation.
          </p>
        </article>
        <article className="rounded-lg border border-[var(--line)] bg-white p-5">
          <Trophy className="mb-3 text-[var(--brand)]" aria-hidden="true" />
          <h2 className="font-semibold">Auto grading</h2>
          <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
            The backend computes score from submitted answers.
          </p>
        </article>
      </section>
    </main>
